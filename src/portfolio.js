...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1g1DMwEAKFbjRkPYy63zgL6fL1US2-HVA/view?usp=sharing",
...
const experience = {
  ...
  description:
    "I've completed one internship and two office jobs. I've mostly done projects on my own and I am actively looking for freelance projects. I love organizing workshops to share my knowledge with others.",
      ...
      experiences: [
        {
          ...
          location: "Office",
          description:
            "I worked on the Ecommerce Multi Vendor Site which helped me in development of practical skills. I also worked on music streaming site as well as on it's dashboard with PHP .",
          color: "#0071C5",
        },
        {
          ...
          location: "Office",
          description:
            "I worked on multiple systems i.e. ERP, Files Manager and Web Based POS and Inventory Management System.",
          color: "#0071C5",
        },
        {
          ...
          description:
            "Created Trello based web game, ERP system, Ecommerce Site and developed Microservices for Food Ordering App on Node.js. Also created web version of this app on React.js and TypeScript.",
          color: "#ee3c26",
        }
      ],
    },
...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects make use of a vast variety of latest technology tools. My best experience is to create NodeJS Backend Projects, Laravel Projects and React Project. Below are some of my projects. Note that not all of the mentioned projects are on GitHub yet.",
...
const projects = {
  data: [
    ...
    },
    {
      ...
      description:
        "A profile manager with unique features such as files manager with customization.",
      languages: [
        {
          name: "HTML5",
          iconifyClass: "vscode-icons:file-type-html",
    ...
    },
    {
      ...
      url: "#",
      description:
        "A complete payroll system implemented in Laravel framework",
      languages: [
        {
          name: "HTML5",
          iconifyClass: "vscode-icons:file-type-html",
    ...
    },
    {
      ...
      description:
        "A POS system with Inventory Management implemented in Laravel framework",
      languages: [
        {
          name: "HTML5",
          iconifyClass: "vscode-icons:file-type-html",
    ...
    },
    {
      ...
      description:
        "Fully secure microservices for a startup implemented in Node.js",
      languages: [
        {
          name: "JavaScript",
          iconifyClass: "logos-javascript",
    ...
    },
    {
      ...
      description:
        "A react native food order app in beta version",
      languages: [
        {
          name: "React-Native",
    ...
    },
    {
      ...
      description:
        "A game based on trello scores for employees.",
      languages: [
        {
          name: "HTML5",
          iconifyClass: "vscode-icons:file-type-html",
    ...
    },
    {
      ...
      description:
        "A semester project for learning. It generates machine learning based workout plans. Dashboard is implemented on Django",
      languages: [
        {
          name: "HTML5",
          iconifyClass: "vscode-icons:file-type-html",
    ...
    },
    {
      ...
      description:
        "An ecommerce site implemented in Django framework",
      languages: [
        {
          name: "JavaScript",
          iconifyClass: "logos-javascript",
